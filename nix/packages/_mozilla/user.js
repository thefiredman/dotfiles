...
lockPref("reader.parse-on-load.enabled", false); // Reader View
lockPref("browser.tabs.firefox-view", false); // Firefox-view
...
// lockPref("browser.sessionstore.interval", 30000); // minimum interval between session save operations
